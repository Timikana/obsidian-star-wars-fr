...
alias: []
espece: Karkarodon
affiliation: [Confédération des Systèmes Indépendants, Empire Sith (agent)]
periode: [Guerres Cloniques]
statut: Décédé (canon)
canon: Canon
premiere_apparition: The Clone Wars — Water War (2012)
acteur_voix: Yancey Arias
sabre_couleur: 
sabre_hex: 
couleur: empire
couleur_hex: "#424242"
cssclasses:
  - perso-empire
tags: [personnage, karkarodon, separatiste, mon-cala, canon]
---
...
## Relations
- Comte Dooku (maître)
- Prince Lee-Char (rival, vainqueur)
- Ahsoka Tano, Anakin Skywalker, Kit Fisto (adversaires)

## Apparitions
The Clone Wars saison 4, arc Mon Cala (canon).
