...
alias: [Kyle]
espece: Humain
affiliation: [Empire (passé), Alliance Rebelle, Nouvel Ordre Jedi]
periode: [Empire, Nouvelle République (Légendes)]
statut: vivant (Légendes)
canon: Légendes
premiere_apparition: Dark Forces (jeu, 1995)
acteur_voix: Jeff Bennett (Jedi Outcast)
...
## Sabre(s) laser
- **Bleu** (sabre construit par lui-même), puis **vert**.

## Apparitions
Jeux Dark Forces, Jedi Knight, Jedi Academy
