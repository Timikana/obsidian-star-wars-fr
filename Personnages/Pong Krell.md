...
alias: [Maître Krell]
espece: Besalisk
affiliation: [Ordre Jedi (déchu, allié secret de Dooku)]
periode: [Guerre des Clones]
statut: mort (~21 BBY, exécuté par les clones de Rex)
canon: Canon
premiere_apparition: Clone Wars S4 (2012)
acteur_voix: Dave Fennoy
...
## Relations
- Ennemis : [[Capitaine Rex]] (qui ordonne son exécution), 501e Légion
- Allié : [[Comte Dooku]]

## Sabre(s) laser
- **Deux sabres jaunes double-lame** ; style brutal Jar'Kai + double-lame.

## Apparitions
Animés Clone Wars (S4 arc Umbara)
